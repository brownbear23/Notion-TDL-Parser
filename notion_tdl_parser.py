...
tdl_template_doc_dir = "/Users/billhan/Desktop/Dev/Notion-TDL-Parser/notion/ms_word_writer/tdl_template.docx"
doc_name = datetime.now().strftime("TDL_%y%m%d_%H%M")
